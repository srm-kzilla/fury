...
func registerUserInDb(user models.UserData) (primitive.ObjectID, error) {
	...
	newMailEmbed := mailer.MailEmbed{
		...
		Body:        "We’ve received your registration for our annual 2023 SRMKZILLA recruitments, so get ready for a mysterious and exciting adventure in our ZILLA MYSTERY MACHINE!<br><br> We have various domains like<br> Technical, Events, Corporate, and Editorial.<br><br> Dive into the world of technology, coding, and innovation. Solve complex challenges and create amazing projects that'll leave everyone in awe like Velma, with the Technical team.<br><br> If you wanna execute thrilling events, workshops, and competitions that keep the club buzzing with energy like the ever-flamboyant Daphne, you’ll feel right at home in the Events team.<br><br> Are you a natural leader with an eye for organization, managing resources, and running the club smoothly like Fred? The Corporate domain is perfect for you.<br><br> If you can craft compelling narratives, make stellar GFX and VFX designs, and have an insatiable appetite for creativity just like Shaggy, the Editorial domain is the perfect fit for you.<br><br> Uncover the mysteries, showcase your skills, and become a part of the legendary SRMKZILLA Campus Club! Good luck, recruit!<br><br> Complete your application now, at recruitment.srmkzilla.net and be a part of the coolest campus club.<br><br> With love and lanyards,<br> SRMKZILLA",
	}
