  ...
  return (
    <div className="flex flex-col justify-center px-8 py-16">
      ...
      <p className="md:text-xl mt-4">
        Here at <span className="text-highlight">SRMKZILLA</span>, our
        open-source projects define who we are because we believe in making
        knowledge and our products accessible to people from all walks of life.
        We believe{" "}
