      ...
      <div className={"main"}>
        {data === "Accepted" ? (
          <div className={"mainAccepted"}>
            ...
            <div className={"wrapperText"}>
              ...
              <p>
                ...
                have any quesries ping us on out Instagram handle.
              </p>
              <h5>
          ...
          <div className={"rejectWrapper"}>
            ...
            <p>
              Although it did't workout this time, we may contact you if we come
              across another opening that we think could interest you and may be
              a good match for your skills and experience.
            </p>
            <p>
