...
const BranchOptions = () => (
    <>
        ...
        ;
        <option
            value="automotive_engineering_with_specialization_in_electric_&_hybrid_vehicles_(in_collaboration_with_arai_pune)">
        ...
        ;
        <option
            value="electronics_and_computer_engineering_electronics_and_communication_engineering_w/s_vlsi_&_embedded_systems">
